...
package=PODIO
version=v0
PACKAGE_ROOT=$(PODIOROOT)
srcdir=../src
bin=../$(PODIO_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/data/BOSSParallel/ExternalInterface/Externals/PODIO/amd64_linux26/
project=ExternalInterface
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(PODIO_linkopts) 
...
use_stamps=  $(PODIO_stamps) 
use_cflags=  $(PODIO_cflags) 
use_pp_cflags=  $(PODIO_pp_cflags) 
use_cppflags=  $(PODIO_cppflags) 
use_pp_cppflags=  $(PODIO_pp_cppflags) 
use_fflags=  $(PODIO_fflags) 
use_pp_fflags=  $(PODIO_pp_fflags) 
includes= $(ppcmd)"/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/podio/include/" $(use_includes)
fincludes= $(includes)
