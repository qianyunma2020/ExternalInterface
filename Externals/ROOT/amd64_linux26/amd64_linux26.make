...
package=ROOT
version=v0
PACKAGE_ROOT=$(ROOTROOT)
srcdir=../src
bin=../$(ROOT_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/data/BOSSParallel/ExternalInterface/Externals/ROOT/amd64_linux26/
project=ExternalInterface
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(ROOT_linkopts) 
...
use_stamps=  $(ROOT_stamps) 
use_cflags=  $(ROOT_cflags) 
use_pp_cflags=  $(ROOT_pp_cflags) 
use_cppflags=  $(ROOT_cppflags) 
use_pp_cppflags=  $(ROOT_pp_cppflags) 
use_fflags=  $(ROOT_fflags) 
use_pp_fflags=  $(ROOT_pp_fflags) 
includes= $(ppcmd)"/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.20.02-d9e99/x86_64-slc6-gcc8-opt/include" $(use_includes)
fincludes= $(includes)
