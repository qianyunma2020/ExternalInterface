...
#cmt_local_tagfile = $(ROOT_tag).make
cmt_local_tagfile = $(bin)$(ROOT_tag).make
...
#cmt_final_setup = $(bin)ROOTsetup.make
...
#cmt_local_tagfile_make = $(ROOT_tag)_make.make
cmt_local_tagfile_make = $(bin)$(ROOT_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)ROOT_makesetup.make
...
#cmt_local_tagfile_make = $(ROOT_tag).make
cmt_local_tagfile_make = $(bin)$(ROOT_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)ROOTsetup.make
cmt_local_make_makefile = $(bin)make.make
