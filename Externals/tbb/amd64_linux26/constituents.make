...
#cmt_local_tagfile = $(tbb_tag).make
cmt_local_tagfile = $(bin)$(tbb_tag).make
...
#cmt_final_setup = $(bin)tbbsetup.make
...
#cmt_local_tagfile_make = $(tbb_tag)_make.make
cmt_local_tagfile_make = $(bin)$(tbb_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)tbb_makesetup.make
...
#cmt_local_tagfile_make = $(tbb_tag).make
cmt_local_tagfile_make = $(bin)$(tbb_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)tbbsetup.make
cmt_local_make_makefile = $(bin)make.make
