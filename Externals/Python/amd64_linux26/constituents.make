...
#cmt_local_tagfile = $(Python_tag).make
cmt_local_tagfile = $(bin)$(Python_tag).make
...
#cmt_final_setup = $(bin)Pythonsetup.make
...
#cmt_local_tagfile_make = $(Python_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Python_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Python_makesetup.make
...
#cmt_local_tagfile_make = $(Python_tag).make
cmt_local_tagfile_make = $(bin)$(Python_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Pythonsetup.make
cmt_local_make_makefile = $(bin)make.make
