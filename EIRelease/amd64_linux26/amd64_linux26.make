...
EIRelease_tag=$(tag)
EIRELEASEROOT=/data/BOSSParallel/ExternalInterface/EIRelease
EIRelease_root=/data/BOSSParallel/ExternalInterface/EIRelease
EIRELEASEVERSION=v0
EIRelease_cmtpath=/data/BOSSParallel/ExternalInterface
EIRelease_project=ExternalInterface
Python_tag=$(tag)
...
package=EIRelease
version=v0
PACKAGE_ROOT=$(EIRELEASEROOT)
srcdir=../src
bin=../$(EIRelease_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/data/BOSSParallel/ExternalInterface/EIRelease/amd64_linux26/
project=ExternalInterface
cmt_installarea_paths= $(cmt_installarea_prefix)/$(CMTCONFIG)/bin
use_linkopts= $(cmt_installarea_linkopts)   $(EIRelease_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
LD_LIBRARY_PATH=/data/BOSSParallel/BesDataModel/InstallArea/amd64_linux26/lib:/data/BOSSParallel/sniper/InstallArea/amd64_linux26/lib:/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.20.02-d9e99/x86_64-slc6-gcc8-opt/lib:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/K4FWCore/lib:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/Gaudi/lib:/cvmfs/sft.cern.ch/lcg/releases/DD4hep/01-12-01-65a08/x86_64-slc6-gcc8-opt/lib:/cvmfs/sft.cern.ch/lcg/releases/XercesC/3.1.3-b3bf1/x86_64-slc6-gcc8-opt/lib:/cvmfs/sft.cern.ch/lcg/releases/Geant4/10.06.p01-1349a/x86_64-slc6-gcc8-opt/lib64:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/GEAR/lib:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/plcio/lib:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/EDM4hep/lib64:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/podio/lib64:/cvmfs/cepcsw.ihep.ac.cn/prototype/releases/externals/97.0.0/LCIO/lib:/cvmfs/sft.cern.ch/lcg/releases/java/8u222-884d8/x86_64-slc6-gcc8-opt/jre/lib/amd64:/cvmfs/sft.cern.ch/lcg/views/LCG_97/x86_64-slc6-gcc8-opt/lib64:/cvmfs/sft.cern.ch/lcg/views/LCG_97/x86_64-slc6-gcc8-opt/lib:/cvmfs/sft.cern.ch/lcg/releases/gcc/8.3.0-cebb0/x86_64-slc6/lib:/cvmfs/sft.cern.ch/lcg/releases/gcc/8.3.0-cebb0/x86_64-slc6/lib64:/cvmfs/sft.cern.ch/lcg/releases/binutils/2.30-e5b21/x86_64-slc6/lib:/cvmfs/sft.cern.ch/lcg/contrib/git/lib64:/usr/local/lib:/usr/local/gcc/lib64:/usr/lib64/classads:/usr/lib64:/usr/lib:/cvmfs/sft.cern.ch/lcg/releases/R/3.2.5-7cecf/x86_64-slc6-gcc8-opt/lib64/R/library/readr/rcon:/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.1.3-78165/x86_64-slc6-gcc8-opt/lib
use_requirements=requirements $(CMT_root)/mgr/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements 
use_includes= $(ppcmd)"/usr/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.20.02-d9e99/x86_64-slc6-gcc8-opt/include" 
use_fincludes= $(use_includes)
use_stamps=  $(EIRelease_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps) 
use_cflags=  $(EIRelease_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(EIRelease_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(EIRelease_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(EIRelease_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(EIRelease_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(EIRelease_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries) 
